...
const BANNER_COPY = {
  ops: {
    label: 'NEW INCIDENT · Asset Intelligence OS',
    body:  'EAST-CCGT-1 · Block 2 · BFP-3A · vibration anomaly · 02:47 SGT',
  },
  opsRouteBack: {
    label: 'ROUTED BACK · Asset Intelligence OS',
  ...
  opsConfirmedReturn: {
    label: 'WO SUBMITTED · Asset Intelligence OS',
  ...
  onsite: {
    label: 'INCOMING HANDOFF · Asset Intelligence OS',
  ...
  analyst: {
    label: 'INCOMING ESCALATION · Asset Intelligence OS',
...
const PRIYA_OPTION_LABEL = {
  ...
  'cross-site':  'Cross-site balance · North-CCGT-1 standby',
...
const INITIAL_DIAGNOSIS_RATIONALE = [
  ...
  { text: 'Pattern-match · 3 prior BFP race-spalling failures across fleet (East-CCGT-2 · North-CCGT-1 · South-CHP)',
    strength: 'met',     badgeLabel: 'fully met' },
...
// ── Hardcoded incident data (East-CCGT-1 BFP-3A) — W3.9 pivot ──
const INCIDENT = {
  id: 'INC-2026-0537',
  asset: 'EAST-CCGT-1 · Block 2 · BFP-3A',
...
const PRE_EXISTING_INCIDENTS = [
  ...
  {
    id: 'INC-2026-0532',
    asset: 'South-CHP · Cooling Tower 2',
...
const PERSONA_OWN_TASKS = {
  ...
  offsite: [
    {
      id: 'RCA-2026-0034',
      asset: 'North-CCGT-1 · GT-1',
      body: 'North-CCGT-1 GT-1 trip RCA · lead investigator',
      severity: 'INFO', state: 'IN PROGRESS', stateClass: 'info',
    ...
    {
      id: 'ER-2026-0089',
      asset: 'East-CCGT-2 · BFP',
      body: 'East-CCGT-2 BFP overhaul technical review',
    ...
    {
      id: 'CR-2026-0156',
      asset: 'West-Power · Generator',
      body: 'West-Power generator stator advisory · stakeholder call',
  ...
  analyst: [
    {
      id: 'TRD-2026-0218',
      asset: 'North-CCGT-1 · Block 1',
      body: 'Cross-site balancing · North-CCGT-1 standby evaluation · capacity reserve sizing',
      severity: 'INFO', state: 'IN PROGRESS', stateClass: 'info',
    ...
    {
      id: 'TRD-2026-0224',
      asset: 'East-CCGT-1 · Forward Curve',
...
// W3.6 — multi-source caption helpers (3 source styles: asset-intelligence / knowledge-graph / netzero-os)
function buildAiSourceCaption(extraClass) {
  const cap = el('div', 'ai-source' + (extraClass ? ' ' + extraClass : ''));
  cap.innerHTML = `<span class="ai-source-icon">✦</span> asset-intelligence.live`;
  return cap;
}
...
function playSOPAnticipationTheater() {
  ...
  if (window.LOG) {
    window.LOG.appendLine({
      ...
      dataSource: 'Asset Intelligence OS',
  ...
  slot1.innerHTML = `
    <div class="as-step" data-step="1" data-status="awaiting-add">
      ...
      <div class="as-step-body">
        <span class="as-step-msg">Telemetry snapshot pre-fetched by Asset Intelligence OS · pending operator confirmation</span>
...
function unlockActionStep2() {
  ...
  step2.querySelector('.as-step-body').innerHTML = `
    <span class="as-step-spinner"><span class="reveal-dots"><span></span><span></span><span></span></span></span>
    <span class="as-step-msg">Asset Intelligence OS · finding on-duty engineers…</span>`;
...
function buildScreenDSourceLegend() {
  ...
  legend.innerHTML = `
    <span class="source-chip">
      ...
      <span>Asset Intelligence OS</span>
    </span>
    <span class="source-chip">
    ...
    <div class="diag-hypothesis-card">
      ...
      <div class="see-reasoning-panel" style="display:none">
        ...
        <div class="reasoning-step">
          ...
          <span class="rs-body"><span class="rs-agent">Turbine Diagnostic Agent</span> pattern-matched against 3 prior RCAs across the fleet (East-CCGT-2 &middot; 2025-08, North-CCGT-1 &middot; 2025-11, East-CCGT-1 &middot; 2024-09 &mdash; all compressor fouling, all humidity-correlated).</span>
        </div>
        <div class="reasoning-step">
...
function fireRevealBlock2Agents() {
  ...
  const lines = [
    { ts: '02:47:16', source: 'pl', text: 'pulling PSO commitment window 09:00–18:00 SGT',         dataSource: 'Asset Intelligence OS', nodeChain: ['esc-pso','pred-mw-derate'] },
...
function fireRevealBlock3Agents() {
  ...
  const lines = [
    { ts: '02:47:19', source: 'triage',           text: 'pattern-match · 3 prior RCAs · compressor fouling humidity-correlated', dataSource: 'Asset Intelligence KG', nodeChain: ['rca-2025-014-north','rca-2024-093-east','rca-2025-031-east2','pat-comp-fouling'] },
    { ts: '02:47:20', source: 'triage',           text: 'diagnosis hypothesis · 78% confidence',                                  dataSource: 'Asset Intelligence OS', nodeChain: ['pat-comp-fouling'] },
    ...
    { ts: '02:47:22', source: 'critic-power-gen', text: 'KG path validated · humidity-fouling matches GE 9HA degradation curve ✓', dataSource: 'Asset Intelligence KG', nodeChain: ['pat-comp-fouling','mdl-humidity-v3','oem-ge-9ha-manual'] },
    { ts: '02:47:23', source: 'orchestrator',     text: 'recommendation ready · SOP-WASH-001 · awaiting dispatch',                 dataSource: 'Asset Intelligence OS', nodeChain: ['rec-oem-playbook'] },
  ];
  lines.forEach((line, idx) => {
    pushReveal(() => {
      window.LOG.appendLine(line);
...
function appendDispatchCaptureFooter() {
  ...
  footer.innerHTML = `
    <div class="dcf-line">
      ...
      <span class="dcf-txt"><strong>Asset Intelligence OS</strong> confirms SOP followed</span>
    </div>
    <div class="dcf-line">
      <span class="dcf-ic">✓</span>
...
function paintLimSummaryComplete(revised) {
  ...
  if (revised) {
    ...
    // W8 C.1 — confirmation pill: Faye already passed this through Asset Intelligence OS · pending onsite verification.
    tileHtml = `
      <div class="sr-hypothesis">
        <div class="sr-hyp-row">
          <span class="sr-hyp-name">${hyp.primary}</span>
...
function onVerdictConfirm() {
  ...
  if (window.LOG) {
    window.LOG.appendLine({ ts: currentSGTLog(), source: 'workflow', text: 'Asset Intelligence OS hypothesis confirmed by Lim Wei Jie · WO submitted', dataSource: 'Asset Intelligence OS', nodeChain: ['sop-bfp-vibration-investigation'] });
    window.LOG.appendLine({ ts: currentSGTLog(), source: 'workflow', text: 'Workflow trace · P2 Onsite → P1 Ops Tower · WO chain enriched · Faye Sit notified', dataSource: 'Asset Intelligence OS', nodeChain: ['r-kumar'] });
  }
...
function appendConfirmedCaptureFooter() {
  ...
  const footer = el('div', 'dispatch-capture-footer');
  footer.innerHTML = `
    <div class="dcf-line"><span class="dcf-ic">✓</span><span class="dcf-txt"><strong>Asset Intelligence OS</strong> · diagnosis confirmed · WO submitted</span></div>
...
function onDiagnosisConfirmedClick() {
  ...
  if (window.LOG) {
    window.LOG.appendLine({
      ...
      dataSource: 'Asset Intelligence OS',
      nodeChain: ['pump-casing-crack-pattern', 'casing-bfp-3a', 'casing-rca-east-2023'],
    });
  }
  ...
  slot.insertAdjacentHTML('beforeend', `
    <div class="revise-diagnosis-tile">
      ...
      <div class="rdt-body">
        ...
        <div class="rdt-text">
          Asset Intelligence OS detected that in addition to the bearings the main reason for this was actually a <span class="dyn-name">crack in pump casing on BFP-3A</span> based on call with <span class="dyn-name">Dr. A. Ismail</span>.
        </div>
      </div>
...
function advanceToRoutedRevisedDiagnosis() {
  ...
  if (window.LOG) {
    window.LOG.appendLine({ ts: currentSGTLog(), source: 'workflow', text: 'State advance · REVISED_DIAGNOSIS_ROUTED · routed to Faye Sit for ops + commercial impact', dataSource: 'Asset Intelligence OS', nodeChain: ['r-kumar'] });
    window.LOG.appendLine({ ts: currentSGTLog(), source: 'workflow', text: 'KG enriched · revised diagnosis + call transcript attached to incident', dataSource: 'Asset Intelligence OS', nodeChain: ['pump-casing-crack-pattern'] });
  }
  fireAgentCardLifecycle('workflow', 2000);
  render();
}
...
function appendRevisedDiagnosisCaptureFooter() {
  ...
  const footer = el('div', 'dispatch-capture-footer');
  footer.innerHTML = `
    <div class="dcf-line"><span class="dcf-ic">✓</span><span class="dcf-txt"><strong>Asset Intelligence OS</strong> · <span class="dyn-name">Faye Sit</span> notified · revised diagnosis routed</span></div>
...
function appendEscalationCaptureFooter() {
  ...
  const footer = el('div', 'dispatch-capture-footer');
  footer.innerHTML = `
    <div class="dcf-line"><span class="dcf-ic">✓</span><span class="dcf-txt"><strong>Asset Intelligence OS</strong> confirms revised diagnosis SOP followed</span></div>
...
function fireWorkflowAgentArcEscalate() {
  ...
  const lines = [
    { delay: 200,  line: { ts: '02:56:10', source: 'workflow', text: 'Lim Wei Jie · escalation captured · revised diagnosis pump casing crack', dataSource: 'Asset Intelligence OS', nodeChain: ['lim-wei-jie', 'pump-casing-crack-pattern', 'casing-bfp-3a'] } },
    { delay: 900,  line: { ts: '02:56:11', source: 'workflow', text: 'handoff sequence recorded · P2 Onsite → P3 Offsite · approval pending', dataSource: 'Asset Intelligence OS', nodeChain: ['lim-wei-jie', 'dr-ismail'] } },
    { delay: 900,  line: { ts: '02:56:12', source: 'workflow', text: 'SOP-BFP-VIBR-001 · revised diagnosis + call transcript attached to KG', dataSource: 'Asset Intelligence OS', nodeChain: ['sop-bfp-vibration-investigation', 'pump-casing-crack-pattern'] } },
  ];
  let t = 0;
...
function startIsmailScreenDReveal() {
  ...
  if (window.LOG) {
    window.LOG.appendLine({
      ts: currentSGTLog(),
      source: 'triage',
      text: 'Turbine Diagnostic Agent · pulling Ismail\'s 2023 East-2 BFP casing field-experience pattern + prior RCA traversal',
      dataSource: 'Asset Intelligence OS',
      nodeChain: ['casing-rca-east-2023', 'pump-casing-crack-pattern', 'dr-ismail'],
    });
  }
  pushReveal(() => {
...
function appendIsmailApprovalCaptureFooter() {
  ...
  const footer = el('div', 'dispatch-capture-footer');
  footer.innerHTML = `
    <div class="dcf-line"><span class="dcf-ic">✓</span><span class="dcf-txt"><strong>Asset Intelligence OS</strong> · escalation approval sign-off recorded</span></div>
...
function fireWorkflowAgentArcApprove() {
  ...
  fireAgentCardLifecycle(agentId, 3000);
  const lines = [
    { delay: 200, line: { ts: '02:58:05', source: 'workflow', text: 'Sign-off recorded · revised diagnosis confirmed · escalation approved', dataSource: 'Asset Intelligence OS', nodeChain: ['dr-ismail', 'pump-casing-crack-pattern'] } },
    { delay: 900, line: { ts: '02:58:06', source: 'workflow', text: 'Workflow trace · P3 Offsite → P1 Ops Tower · route-back for ops + commercial impact action', dataSource: 'Asset Intelligence OS', nodeChain: ['dr-ismail', 'r-kumar'] } },
    { delay: 900, line: { ts: '02:58:07', source: 'workflow', text: 'KG enriched · sign-off attached · routed back to Faye Sit · ops manager action queued', dataSource: 'Asset Intelligence OS', nodeChain: ['sop-bfp-vibration-investigation', 'r-kumar'] } },
  ];
  let t = 0;
  lines.forEach((entry, idx) => {
    t += entry.delay;
...
function appendNotifyTradingDeskCaptureFooter() {
  ...
  const footer = el('div', 'dispatch-capture-footer');
  footer.innerHTML = `
    <div class="dcf-line"><span class="dcf-ic">✓</span><span class="dcf-txt"><strong>Asset Intelligence OS</strong> · ops escalation logged · trading desk notification queued</span></div>
...
function fireWorkflowAgentArcNotify() {
  ...
  fireAgentCardLifecycle(agentId, 3000);
  const lines = [
    { delay: 200, line: { ts: '02:59:02', source: 'workflow', text: 'Faye Sit · trading desk notification queued · commercial impact context attached', dataSource: 'Asset Intelligence OS', nodeChain: ['r-kumar', 'pred-mw-derate'] } },
    { delay: 900, line: { ts: '02:59:03', source: 'workflow', text: 'Handoff sequence recorded · P1 Ops Tower → P4 Asset Perf · trading desk action queued', dataSource: 'Asset Intelligence OS', nodeChain: ['r-kumar', 'p-sundaram'] } },
    { delay: 900, line: { ts: '02:59:04', source: 'workflow', text: 'KG enriched · ~SGD 2.4M revenue exposure attached · Trader desk routing complete', dataSource: 'Asset Intelligence OS', nodeChain: ['pred-mw-derate', 'p-sundaram'] } },
  ];
  let t = 0;
  lines.forEach((entry, idx) => {
    t += entry.delay;
...
function spawnAnalystScreenContent() {
  ...
  const contentHTML = `
    ...
    <button class="ac-lock-cta" type="button" disabled>
      Lock decision · Asset Intelligence OS confirms revenue exposure neutralized
    </button>`;
  card.insertAdjacentHTML('beforeend', contentHTML);
}
...
function appendLockDecisionCaptureFooter() {
  ...
  const footer = el('div', 'dispatch-capture-footer');
  footer.innerHTML = `
    <div class="dcf-line"><span class="dcf-ic">✓</span><span class="dcf-txt"><strong>Asset Intelligence OS</strong> · trading decision locked · commercial close</span></div>
...
function fireWorkflowAgentArcLock() {
  ...
  const optionLabel = state.priya.selectedOption ? PRIYA_OPTION_LABEL[state.priya.selectedOption] : '—';
  const lines = [
    { delay: 200, line: { ts: '03:01:11', source: 'workflow', text: `Priya Sundaram · trading decision locked · ${optionLabel}`, dataSource: 'Asset Intelligence OS', nodeChain: ['p-sundaram', 'pred-mw-derate'] } },
    { delay: 900, line: { ts: '03:01:12', source: 'workflow', text: 'Decision audit + market position lineage recorded · cycle close', dataSource: 'Asset Intelligence OS', nodeChain: ['p-sundaram'] } },
    { delay: 900, line: { ts: '03:01:13', source: 'workflow', text: 'KG · trading outcome attached to INC-2026-0537 · revenue exposure neutralized', dataSource: 'Asset Intelligence OS', nodeChain: ['pred-mw-derate', 'sop-bfp-vibration-investigation'] } },
  ];
  let t = 0;
  lines.forEach((entry, idx) => {
    t += entry.delay;
...
function buildLandedIncidentRow() {
  ...
  return {
    ...
    body: 'BFP-3A NDE bearing housing vibration RMS exceeds ISO 10816-7 Zone C threshold. Asset Intelligence OS hypothesis: NDE bearing race spalling (early-stage). Pending onsite verification.',
...
function renderMonitoringView(root) {
  ...
  hdr.innerHTML = `
    <div class="mon-hdr-left">
      <div class="mon-hdr-brand">Asset Intelligence OS</div>
    </div>
...
const PRIYA_LOCKED_OPTION_TILE = {
  ...
  'cross-site': { what: 'Hedge locked · Cross-site North balancing',    why: 'North-CCGT-1 standby capacity nominated for HH18–HH21 cover.' },
...
function updateLaptopActiveTasks() {
  ...
  const baselineTiles = `
    <div class="td-task-tile" data-tile="trd-0218">
      <div class="td-task-what">Cover North-CCGT-1 standby balancing position</div>
  ...
  if (locked) {
    ...
    topTile = `
      <div class="td-task-tile td-task-urgent" data-tile="inc">
        ...
        <div class="td-task-why">EAST-CCGT-1 BFP-3A unplanned shutdown · 4hrs · ~200 MWh at risk · PSO 09:00–18:00 SGT</div>
        <div class="td-task-meta">
...
const P1_NARRATIVE_SECTIONS = [
  {
    ...
    sub: 'Agents pull the right Asset Intelligence OS metrics + run pattern-match against prior incidents to land a single criticality + diagnosis summary card.',
    meta: '4 domain experts · 2 critics · sources: Asset Intelligence · Netscope · Org Knowledge',
  },
  {
    num: '2',
    ...
    meta: '3 domain experts · 2 critics · sources: Asset Intelligence · SOP store',
  },
  {
    num: '3',
...
const P1_SECTION_1 = {
  ...
  domain: [
    { name: 'Sensor Anomaly Inspector',      persistent: 'inspection', dataSource: 'Asset Intelligence' },
    ...
    { name: 'Incident Summary Synthesizer',  persistent: null,         dataSource: 'Asset Intelligence' },
  ],
  orch: [
  ...
  sources: ['Asset Intelligence · telemetry', 'Netscope · analytics', 'Org Knowledge · SOPs + RCA'],
  narration: [
    'Domain experts pull vibration RMS from Asset Intelligence and pattern-match against prior BFP failures.',
    'Criticality Scoring Agent uses Netscope analytics to confirm severity classification.',
    'Incident Summary Synthesizer hands Faye a single Asset Intelligence OS-sourced summary card.',
  ],
};
...
function buildTacitSinglishCanvas(sectionDef) {
  ...
  const bytes = [
    { txt: 'Byte · casing weld pattern matches East 2023',  unpromoted: false },
    ...
    { txt: 'Byte · Ismail mentioned South case',              unpromoted: true  },
  ];
  return `
...
const KG_NODES = [
  ...
  { id: 'rca-bfp-east-2025',    label: 'RCA · East-2 BFP · 2025-08',   layer: 'L3', x: -15, y: -30, z:  10 },
  { id: 'rca-bfp-skr-2024',    label: 'RCA · North-1 BFP · 2024-11',    layer: 'L3', x:  15, y: -30, z:  10 },
  { id: 'rca-bfp-south-2024', label: 'RCA · South BFP · 2024-05',     layer: 'L3', x:  45, y: -30, z:  10 },
  { id: 'casing-rca-east-2023', label: 'RCA · East-2 BFP casing · 2023-08', layer: 'L3', x:  30, y: -30, z:  -10 },
...
const KG_EDGES = [
  ...
  // L3 RCA → L4 pattern
  { source: 'rca-bfp-east-2025',    target: 'bearing-spalling-pattern' },
  { source: 'rca-bfp-skr-2024',    target: 'bearing-spalling-pattern' },
  { source: 'rca-bfp-south-2024', target: 'bearing-spalling-pattern' },
  ...
  { source: 'casing-rca-east-2023',      target: 'pump-casing-crack-pattern' },
...
const KG_TACIT_NODES = [
  ...
  { id: 'ismail-field-experience-2023',     label: 'Field experience · Ismail · East BFP 2023',    layer: 'L3', x: 380, y: -30, z:  10, canonical: false, isNew: true, cluster: 'tacit' },
...
const KG_CLUSTER_FLOW_EDGES = [
  ...
  { source: 'kg-updater-agent',               target: 'casing-rca-east-2023',                canonical: false, cluster: 'auditor-to-main' },
...
const KG_STAGING_NODES = [
  ...
  { id: 'tacit-byte-1', label: 'Byte · "casing weld pattern matches East 2023"', layer: 'L4', x: 520, y:  60, z:  10, canonical: false, cluster: 'staging', isStaging: true, isPromoted: true },
  ...
  { id: 'tacit-byte-4', label: 'Byte · "Ismail mentioned similar case in South"',     layer: 'L4', x: 520, y: -30, z: -10, canonical: false, cluster: 'staging', isStaging: true, isPromoted: false },
...
const KG_COMMERCIAL_NODES = [
  ...
  { id: 'cross-site-north-availability', label: 'Cross-site · North-CCGT-1 standby', layer: 'L7', x: 720, y: LAYER_Y.L7, z:  10, canonical: false, cluster: 'commercial' },
  { id: 'cross-site-west-availability',  label: 'Cross-site · West-Power available', layer: 'L7', x: 780, y: LAYER_Y.L7, z: -10, canonical: false, cluster: 'commercial' },
  { id: 'south-chp-availability',    label: 'South-CHP · availability',            layer: 'L7', x: 700, y: LAYER_Y.L7, z:  30, canonical: false, cluster: 'commercial' },
  { id: 'west-power-spinning-reserve', label: 'West-Power · spinning reserve',       layer: 'L7', x: 730, y: LAYER_Y.L7, z: -20, canonical: false, cluster: 'commercial' },
  ...
  { id: 'north-cogen-standby',        label: 'North-Cogen · standby state',          layer: 'L7', x: 750, y: LAYER_Y.L7, z: -30, canonical: false, cluster: 'commercial' },
];
...
const KG_COMMERCIAL_EDGES = [
  ...
  { source: 'ppa-pso-2026',                 target: 'cross-site-north-availability', canonical: false, cluster: 'commercial-internal' },
  { source: 'ppa-pso-2026',                 target: 'cross-site-west-availability',  canonical: false, cluster: 'commercial-internal' },
  { source: 'cross-site-north-availability', target: 'hedge-instrument-catalog',     canonical: false, cluster: 'commercial-internal' },
  ...
  { source: 'south-chp-availability',     target: 'ppa-pso-2026',           canonical: false, cluster: 'commercial-internal' },
  { source: 'interconnector-malaysia',     target: 'grid-frequency-50hz',    canonical: false, cluster: 'commercial-internal' },
  { source: 'transmission-275kv-ehv',      target: 'north-cogen-standby',    canonical: false, cluster: 'commercial-internal' },
...
const KG_W14R3_EDGES = [
  ...
  { source: 'failure-mode-race-spalling',   target: 'rca-bfp-east-2025',           canonical: false, cluster: 'w14r3-l3' },
  { source: 'failure-mode-race-spalling',   target: 'rca-bfp-skr-2024',           canonical: false, cluster: 'w14r3-l3' },
  { source: 'failure-mode-casing-crack',    target: 'casing-rca-east-2023',        canonical: false, cluster: 'w14r3-l3' },
  ...
  { source: 'west-power-spinning-reserve',  target: 'cross-site-west-availability', canonical: false, cluster: 'w14r3-commercial-fix' },
];
...
const INSPECTION_AGENT_SCRIPT = {
  ...
  steps: [
    ...
    {
      log: { ts: '02:47:15', source: 'inspection', text: 'asset chain assembled · 6 nodes · BFP-3A → HRSG-3 → ST-3 cascade', dataSource: 'Asset Intelligence KG', nodeChain: ['bfp-3a','hrsg-3','st-3','generator-3','transformer-3','switchyard-a'] },
...
const TRIAGE_AGENT_SCRIPT = {
  ...
  steps: [
    {
      log: { ts: '02:47:19', source: 'triage', text: 'pattern-match · 3 prior BFP bearing failures · East-CCGT-2 / North-CCGT-1 / South-CHP', dataSource: 'Asset Intelligence KG', nodeChain: ['rca-bfp-east-2025','rca-bfp-skr-2024','rca-bfp-south-2024','bearing-spalling-pattern'] },
      treeLabel: 'Pattern-match prior RCAs',
      delayMs: 200,
    },
    {
      log: { ts: '02:47:20', source: 'triage', text: 'diagnosis hypothesis · NDE bearing race spalling (early-stage) · 78% confidence', dataSource: 'Asset Intelligence OS', nodeChain: ['bearing-spalling-pattern','bearing-bfp-3a-nde'] },
      treeLabel: 'Form hypothesis',
      delayMs: 900,
    },
    {
      log: { ts: '02:47:21', source: 'triage', text: 'alternatives considered · shaft misalignment 52% · coupling wear 31% · impeller imbalance 19%', dataSource: 'Asset Intelligence OS', nodeChain: ['shaft-bfp-3a','coupling-bfp-3a'] },
      treeLabel: 'Consider alternatives',
      delayMs: 900,
    },
    {
      log: { ts: '02:47:22', source: 'triage', text: 'synthesis · 78% confidence · passing to Power Gen Critic', dataSource: 'Asset Intelligence OS', nodeChain: ['bearing-spalling-pattern'] },
...
const POWER_GEN_CRITIC_SCRIPT = {
  ...
  steps: [
    {
      log: { ts: '02:47:22', source: 'critic-power-gen', text: 'KG path validated · bearing-spalling-pattern matches Sulzer BFP degradation profile ✓', dataSource: 'Asset Intelligence KG', nodeChain: ['bearing-spalling-pattern','sulzer-bfp-manual'] },
      treeLabel: 'Walk KG path backwards',
      delayMs: 200,
    },
    {
      log: { ts: '02:47:23', source: 'critic-power-gen', text: 'cross-check ISO 10816-7 alarm zone C threshold ✓ · onsite verification recommended', dataSource: 'Asset Intelligence KG', nodeChain: ['iso-10816-7-spec','sop-bfp-vibration-investigation'] },
...
function seedLogLines() {
  ...
  appendLogLine({
    ts: '02:47:08',
    source: 'orchestrator',
    text: 'received INC-2026-0537 · EAST-CCGT-1 · Block 2 · BFP-3A',
...
const P2_KG_NODES_DEF = [
  ...
  { id: 'wo-east-2025',        label: 'WO · East 2025',            layer: 'L4', x: 80,   y: 510 },
  { id: 'wo-skr-2024',        label: 'WO · North 2024',             layer: 'L4', x: 237,  y: 510 },
  { id: 'wo-south-2024',     label: 'WO · South 2024',            layer: 'L4', x: 393,  y: 510 },
  { id: 'wo-west-2023',       label: 'WO · West 2023',              layer: 'L4', x: 550,  y: 510 },
  { id: 'rca-east-2025',       label: 'RCA · East 2025',           layer: 'L4', x: 707,  y: 510 },
  { id: 'rca-south-2024',    label: 'RCA · South 2024',           layer: 'L4', x: 863,  y: 510 },
  { id: 'rca-north-coupling', label: 'RCA · North coupling 2025',   layer: 'L4', x: 1020, y: 510 },
...
const P2_KG_EDGES_DEF = [
  ...
  // L4 intra (9 edges)
  ['wo-east-2025', 'rca-east-2025'], ['wo-skr-2024', 'rca-south-2024'],
  ['wo-south-2024', 'rca-south-2024'], ['wo-west-2023', 'rca-north-coupling'],
  ['vib-90d', 'trend-90d'], ['temp-30d', 'trend-90d'],
  ['trend-90d', 'spec-compliance'], ['maint-log', 'align-history'],
  ['brg-replace-log', 'maint-log'],

  // L4 → L5 (11 edges)
  ['rca-east-2025', 'pattern-race'], ['rca-south-2024', 'pattern-crack'],
  ['vib-90d', 'pattern-race'], ['temp-30d', 'pattern-race'],
  ['rca-north-coupling', 'pattern-misalign'], ['align-history', 'pattern-misalign'],
  ['brg-replace-log', 'pattern-race'],
  ['spec-compliance', 'mtbf-model'], ['maint-log', 'mtbf-model'],
  ['trend-90d', 'pattern-imbalance'], ['wo-south-2024', 'pattern-cavitation'],
  ...
  ['rca-east-2025', 'tacit-1'], ['rca-south-2024', 'tacit-2'],
...
function renderP3KGSvg() {
  ...
  const extraNodes = [
    ...
    { id: 'ppa-south-2025',     label: 'PPA · South 2025',      layer: 'L7', x: 214,  y: 980 },
    { id: 'ppa-west-2028',       label: 'PPA · West 2028',        layer: 'L7', x: 348,  y: 980 },
    { id: 'ppa-10yr',            label: 'PPA · 10-yr',            layer: 'L7', x: 482,  y: 980 },
    { id: 'ppa-5yr',             label: 'PPA · 5-yr',             layer: 'L7', x: 616,  y: 980 },
    { id: 'longterm-north',      label: 'Long-term · North',      layer: 'L7', x: 750,  y: 980 },
    ...
    { id: 'south',              label: 'South-CHP',             layer: 'L8', x: 80,   y: 1170 },
    { id: 'west-power',          label: 'West-Power',             layer: 'L8', x: 214,  y: 1170 },
    { id: 'north-cogen',         label: 'North-Cogen',            layer: 'L8', x: 348,  y: 1170 },
    { id: 'senoko',              label: 'Senoko',                 layer: 'L8', x: 482,  y: 1170 },
    { id: 'west-spring',           label: 'West-Spring',              layer: 'L8', x: 616,  y: 1170 },
    ...
    { id: 'west-substation',     label: 'West substation',        layer: 'L8', x: 550,  y: 1240 },
    { id: 'east-substation',   label: 'East substation',      layer: 'L8', x: 707,  y: 1240 },
    { id: 'north-intertie',      label: 'North grid intertie',    layer: 'L8', x: 863,  y: 1240 },
  ...
  const extraEdges = [
    ...
    ['electricity-futures', 'trader-hedge-book'], ['lng-charter', 'longterm-north'],
    ...
    ['ppa-south-2025', 'ppa-pso'], ['ppa-west-2028', 'ppa-10yr'],
    ['ppa-10yr', 'ppa-5yr'], ['longterm-north', 'ppa-10yr'],
    ...
    ['ppa-pso', 'south'], ['ancillary', 'west-power'], ['hedges', 'north-cogen'],
    ['ppa-south-2025', 'south'], ['ppa-west-2028', 'west-power'],
    ['longterm-north', 'north-cogen'], ['ppa-10yr', 'senoko'],
    ['ppa-5yr', 'west-spring'], ['embedded-gen', 'ytl-power-seraya'],
    ['esco-industrial', 'pulau-seraya'],

    // L8 intra (8 edges · cross-site grid topology)
    ['south', 'west-power'], ['west-power', 'interconnect-my'], ['north-cogen', 'grid-50hz'],
    ['senoko', 'west-spring'], ['west-substation', 'west-power'],
    ['east-substation', 'south'], ['pasir-panjang-sw', 'bukit-panjang-fdr'],
    ['north-intertie', 'interconnect-id'],
